...
class TabBarViewController: UITabBarController {
    ...
    private func generateTabBar() {
        viewControllers = [
            ...
            generateVC(viewController: CategoriesViewController(), title: "Categories", image: UIImage(systemName: "square.grid.2x2")?.withTintColor(.gray), selectedImage: UIImage(systemName: "square.grid.2x2.fill")?.withTintColor(UIColor(named: "purplePrimary")!), tag: Tabs.categories.rawValue),
